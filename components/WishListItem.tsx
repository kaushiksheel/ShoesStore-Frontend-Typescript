    ...
    <div className="cursor-pointer group relative card border-[1px] border-[#dbdbdb] rounded-[12px] overflow-hidden bg-white">
      ...
      <div className="card-body p-9 ">
        <p
          ...
          className="font-[600] text-[1.4rem] text-[#71717A] "
        >
          {item.name}
        </p>
      ...
      <button onClick={()=>handleRemoveFromWishlist(item.name)} className="absolute bottom-[-100%] group-hover:bottom-0 bg-[#001134] w-full text-[1.5rem] font-semibold text-white p-5 z-10 transition-all  flex items-center justify-center gap-x-4">
